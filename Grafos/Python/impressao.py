...
plot(grafo5, bbox=(300,300),  edge_width = grafo5.es['weight'], vertex_color = grafo5.vs['cor'])

# Pesos para os vértices
plot(grafo5, bbox=(300,300), vertex_size = grafo5.vs['peso'], edge_width = grafo5.es['weight'], vertex_color = grafo5.vs['cor'])

# Curvatura
plot(grafo5, bbox=(300,300), vertex_size = grafo5.vs['peso'], edge_width = grafo5.es['weight'], vertex_color = grafo5.vs['cor'], edge_curved = 0.4)

# Formato
plot(grafo5, bbox=(0,0,300,300), vertex_size = grafo5.vs['peso'], edge_width = grafo5.es['weight'], vertex_color = grafo5.vs['cor'], edge_curved = 0.4, vertex_shape = 'triangle')